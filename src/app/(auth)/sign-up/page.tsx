...
import { Eye, EyeClosed, Loader2, User, Mail, Lock, CheckCircle, XCircle, ArrowRight } from "lucide-react";
            ...
            <div className="mx-auto w-full max-w-md">
                ...
                <div className="mb-8 text-center sm:mb-12">
                    ...
                    <p className="text-base text-gray-600 sm:text-lg">
                        Create your account to start sending and receiving anonymous messages
                    </p>
                </div>
                                            ...
                                            <div className="mt-2 flex items-center gap-2">
                                                {isCheckingUsername ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <span className={`text-sm ${isUsernameAvailable ? 'text-green-600' : 'text-red-600'}`}>
                                                            {usernameMessage}
                                                        </span>
                                                    </>
                                                )}
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-2">
                    <div className="rounded-lg border border-green-100 bg-green-50/50 p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h4 className="font-medium text-green-800">Completely Anonymous</h4>
                                <p className="text-xs text-green-700">Your identity stays hidden</p>
                            </div>
                        </div>
                    </div>
