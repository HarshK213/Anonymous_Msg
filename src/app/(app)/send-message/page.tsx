            ...
            <div className="mx-auto w-full max-w-2xl">
                ...
                <div className="mb-8 text-center sm:mb-12">
                    ...
                    <p className="mt-3 text-base text-gray-600 sm:text-lg">
                        Enter the username of the person you want to send an anonymous message to
                    </p>
                </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        {usernameMessage && (
                                            <div className={`mt-3 rounded-lg p-3 ${usernameMessage === "User found" ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}>
                                        ...
                                        <div className="mt-4 text-sm text-gray-500 sm:text-base">
                                            <p>Enter the exact username as it appears on their profile</p>
                                        </div>
                                    </FormItem>
                                )}
                            />
                ...
                <div className="mt-8 rounded-xl border border-gray-200 bg-gray-50/50 p-5 sm:mt-10 sm:p-6">
                    ...
                    <ul className="space-y-3 text-sm text-gray-600 sm:text-base">
                        ...
                        <li className="flex items-start">
                            ...
                            <span>Click "Find User" to navigate to their message page</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-gray-500 sm:text-base">
                        Example usernames: <code className="rounded bg-gray-100 px-2 py-1 text-sm">john_doe</code>, 
                        <code className="mx-2 rounded bg-gray-100 px-2 py-1 text-sm">alice123</code>, 
                        <code className="rounded bg-gray-100 px-2 py-1 text-sm">tech_guru</code>
                    </p>
                </div>
            </div>
        </div>
